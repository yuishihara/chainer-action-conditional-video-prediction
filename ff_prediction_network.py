...
class FeedForwardPredictionNetwork(AutoEncoder):
    def __init__(self, color_num=3, frame_num=4, action_num=3):
        super(FeedForwardPredictionNetwork, self).__init__()
        self.name = 'PredictionNetwork'
        ...
        with self.init_scope():
            ...
            self.W_enc = L.Linear(
                in_size=None, out_size=self.factor_num, nobias=True)
